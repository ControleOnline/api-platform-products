...
class Product
{
    ...
    #[ORM\OneToMany(targetEntity: ProductPeople::class, mappedBy: 'product')]
    #[Groups(['product:read'])]
    ...
    #[Groups(['product_category:read', 'product_inventory:read', 'product:read', 'orders-queue:read', 'product_group_product:read', 'order_product:read', 'order_product_queue:read', 'order:read', 'order:write',  'product:write'])]
    private $company;
    ...
    #[Groups(['product_inventory:read', 'product:read', 'orders-queue:read', 'product:write'])]
    ...
    {
        if ($this->productPeople->removeElement($productPeople) && $productPeople->getProduct() === $this) {
            $productPeople->setProduct(null);
        }
