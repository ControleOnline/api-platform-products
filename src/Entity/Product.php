...
class Product
{
    ...
    #[ApiResource(normalizationContext: ['groups' => ['product_category:read', 'product:read', 'order_product:read']])]
    private $id;
    ...
    #[ApiResource(normalizationContext: ['groups' => ['product_category:read', 'product:read', 'product_group_product:read', 'order_product:read', 'order_product_queue:read', 'order:read', 'order_details:read', 'order:write', 'product:write']])]
    private $product;
    ...
    #[ApiResource(normalizationContext: ['groups' => ['product:read', 'product_category:read', 'order_product:read']])]
    ...
    #[ApiResource(normalizationContext: ['groups' => ['product:read', 'product:write']])]
