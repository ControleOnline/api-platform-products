---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/api-platform-products, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/api-platform-products`.
...
- Checkout local: `api-community/modules/controleonline/products`
